...
class TravelTasks:
    ...
    def plan_itinerary(self, agent, city, travel_dates, interests):
        return Task(
            ...
            agent=agent,
            expected_output="A detailed 7-day itinerary with daily plans, including places to visit, stay, and eat."
        )
    ...
    def identify_city(self, agent, origin, cities, interests, travel_dates):
        return Task(
            ...
            agent=agent,
            expected_output="A detailed report on the best city for the trip, including flight costs, weather, and attractions."
        )
    ...
    def gather_city_info(self, agent, city, travel_dates, interests):
        return Task(
            ...
            agent=agent,
            expected_output="A comprehensive city guide including key attractions, local customs, and daily activity recommendations."
        )
