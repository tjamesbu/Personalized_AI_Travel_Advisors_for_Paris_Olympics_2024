...
from Paris.components.link_button import link_button
from Paris.styles.styles import Size, Color, TextColor

def location() -> rx.Component:
    return rx.vstack(
        title("You are here!", 
            #   font_size="Size.DEFAULT.value", 
            #   color=TextColor.ACCENT.value,  # color changes but not the right one ??? 
              ),
        rx.image(
                    src="/paris18.jpeg",
                    alt="Paris",
