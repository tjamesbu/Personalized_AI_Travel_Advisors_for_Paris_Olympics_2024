# Task 1 : Data Source Implementation
...
|Tourist passes|||
|Transportation data|||
|Emergency Contact Numbers|src/data/paris_embassies_website_phone.csv|src/tasks/task1/webscraping_embassy_vivien.ipynb|
