...
# Calculate the relative path to the directory containing advisor_agents.py
helpers_path = Path(__file__).resolve().parent / 'src/tasks/task3/notebooks/priyanka_Paris_Syndrome_crewai_updated'
